        ...
        child: Column(
          children: [
            Container(
              ...
              child: ClipOval(
                child: Image.asset(
                  'assets/indian2.jpeg', // Path to your local image asset
                  width: 400,
                  height: 400,
                  fit: BoxFit.cover,
                ),
            ...
            SizedBox(height: 10),
            Text(
              'Special Offer 10 OFF Dish Full INDIAN Dish ',
            ...
            ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Added Special Offer Dish to cart!'),
                  ),
                );
