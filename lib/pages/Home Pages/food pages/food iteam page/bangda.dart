...
class bangda extends StatelessWidget {
        ...
        child: Column(
          children: [
            Container(
              ...
              child: ClipOval(
                child: Image.asset(
                  'assets/fried fish bangda.jpeg', // Path to your local image asset
                  width: 300,
                  height: 300,
                  fit: BoxFit.cover,
                ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Added Fried Fish Bangda to cart!'),
                  ),
                );
                Navigator.pushNamed(context, 'card');
              },
