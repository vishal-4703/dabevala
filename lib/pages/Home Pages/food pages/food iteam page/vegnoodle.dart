...
class vegnoodle extends StatelessWidget {
  @override
        ...
        child: Column(
          children: [
            Container(
              ...
              child: ClipOval(
                child: Image.asset(
                  'assets/veg noodle.jpeg', // Path to your local image asset
                  width: 400,
                  height: 400,
                  fit: BoxFit.cover,
                ),
            ...
            ElevatedButton(
              onPressed: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Added Veg Noodle  to cart!'),
                  ),
                );
